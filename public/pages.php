...
<div class="data-layout">
    ...
    <main class="content">
        ...
        <?php else: ?>
            ...
            <section class="card">
                <table>
                    <thead><tr><th>页面</th><th>PV</th><th>IP</th></tr></thead>
                    <tbody>
                    <?php if (empty($data['pages'])): ?>
                        <tr><td colspan="3" class="muted">暂无页面数据</td></tr>
                    <?php else: ?>
                ...
                <div style="margin-top:12px;">
                    ...
                    <canvas id="pagesPie" width="240" height="240"></canvas>
                </div>
            </section>
            <script>
                (function(){
                    const data = <?= json_encode(array_slice($data['pages'] ?? [],0,8)); ?>;
                    ...
                    const canvas = document.getElementById('pagesPie');
                    if(!canvas) return;
